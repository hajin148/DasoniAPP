...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupMainPage() {
        ...
        musicPracticeBtn.setOnClickListener {
            ...
            if(currentUser == null) {
                var a = com.example.dasoniapp.UserAccount(
                    "test@gmail.com",
                    "01011111234",
                    "test",
                    "123123"
    ...
    private fun setupMyPage() {
        ...
        val adminText: TextView = findViewById(R.id.adminText)
        ...
        if (mFirebaseAuth.currentUser != null) {
            val userId = mFirebaseAuth.currentUser!!.uid
            val userRef = FirebaseDatabase.getInstance().getReference("DasoniAPP/users/$userId/admin")

            // Checking whether account is admin or not
